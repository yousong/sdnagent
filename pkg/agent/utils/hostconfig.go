...
func newHostConfigFromBytes(data []byte) (*HostConfig, error) {
	...
	v := struct {
		...
		AdminProjectDomain  string `json:"admin_project_domain"`
		AdminUser           string `json:"admin_user"`
		AdminPassword       string `json:"admin_password"`
		SessionEndpointType string `json:"session_endpoint_type"`
...
func (hc *HostConfig) Auth(ctx context.Context) error {
	...
	debugClient := false
	insecure := true
	auth.Init(a, debugClient, insecure, hc.SslCertfile, hc.SslKeyfile)
	return nil
}
